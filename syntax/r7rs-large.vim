...
syn region r7rsVecN matchgroup=r7rsDelim start=/#[su]\%(8\|16\|32\|64\)(/ end=/)/ contains=r7rsErr,@r7rsComments,r7rsNumber
syn region r7rsVecN matchgroup=r7rsDelim start=/#f\%(32\|64\)(/ end=/)/ contains=r7rsErr,@r7rsComments,r7rsNumber
syn region r7rsVecN matchgroup=r7rsDelim start=/#c\%(64\|128\)(/ end=/)/ contains=r7rsErr,@r7rsComments,r7rsNumber
